...
import com.revplay.analyticsservice.service.RecommendationService;
...
public class RecommendationServiceImpl implements RecommendationService {
    ...
    public List<SongRecommendationResponse> similarSongs(Long songId, int limit) {
        ...
        if (songId == null) {
            throw new AnalyticsValidationException("songId is required");
        }
    ...
    public ForYouRecommendationsResponse forUser(Long userId, int limit) {
        ...
        if (userId == null) {
            throw new AnalyticsValidationException("userId is required");
        }
        AnalyticsValidationUtil.requireLimitInRange(limit, 1, 100);
