package com.revplay.catalogservice.security.service.impl;
...
import com.revplay.catalogservice.security.JwtProperties;
import com.revplay.catalogservice.entity.User;
import com.revplay.catalogservice.enums.UserRole;
import com.revplay.catalogservice.exception.AuthUnauthorizedException;
...
public class JwtServiceImpl implements JwtService {
    ...
    public String generateAccessToken(User user) {
        return generateToken(user, TOKEN_TYPE_ACCESS, 3600 * 24);
    }

    public String generateRefreshToken(User user) {
        return generateToken(user, TOKEN_TYPE_REFRESH, 3600 * 24 * 7);
    }
