...
import com.revplay.playlistservice.constants.ApiPaths;
...
public class UserLikeController {
    ...
    public ResponseEntity<ApiResponse<UserLikeResponse>> likeContent(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(response, "Content liked successfully"));
    }
    ...
    public ResponseEntity<ApiResponse<PagedResponseDto<UserLikeResponse>>> getUserLikes(
        ...
        return ResponseEntity.ok(ApiResponse.success(response, "User likes retrieved"));
    }
}
